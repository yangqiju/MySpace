...
public class FindByPagePlugin extends PluginAdapter {
	...
	public boolean modelFieldGenerated(Field field,
		...
		{
			field.addAnnotation(" @JsonSerialize (using = CustomDateSerializer. class )");
			Set<FullyQualifiedJavaType> its=new HashSet<FullyQualifiedJavaType>();
			its.add(new FullyQualifiedJavaType("org.codehaus.jackson.map.annotate.JsonSerialize"));
			its.add(new FullyQualifiedJavaType("com.joyveb.util.CustomDateSerializer"));
			topLevelClass.addImportedTypes(its);
		}
		System.out.println("modelfield:"+field+":colum="+introspectedColumn.getActualColumnName()+":tb="+introspectedTable.getFullyQualifiedTableNameAtRuntime());
...
//			System.out.println(inclass.getType().getShortName());
	...
	public boolean clientGenerated(Interface interfaze,
		...
		sfield.setName("BEAN_NAME=\""+interfaze.getType().getShortName().toLowerCase().substring(0,1)+
				interfaze.getType().getShortName().substring(1)+"\"");
