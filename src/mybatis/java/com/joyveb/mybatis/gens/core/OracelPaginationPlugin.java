...
//			whereclause = tablename+".Example_Where_Clause";
	...
	public boolean clientGenerated(Interface interfaze,
		...
		FullyQualifiedJavaType returnList = FullyQualifiedJavaType.getNewListInstance();
        returnList.addTypeArgument(new FullyQualifiedJavaType(introspectedTable.getBaseRecordType()));
        DateFormat df = new SimpleDateFormat("EEE MMM ww HH:mm:ss z yyyy", Locale.US);
//		//***********************interface********************************
		Method method = new Method();
		...
		returnList.addTypeArgument(new FullyQualifiedJavaType(HashMap.class.getName()));
