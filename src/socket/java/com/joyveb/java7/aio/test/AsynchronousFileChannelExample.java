...
public class AsynchronousFileChannelExample {
    ...
    public AsynchronousFileChannelExample() throws IOException {
        ...
        final AsynchronousFileChannel fileChannel = AsynchronousFileChannel.open(Paths.get("C:\\go\\api\\test\\newFile.txt"), 
...
//                , StandardOpenOption.DELETE_ON_CLOSE
        ...
        int start = contents.length;//Add
        contents = "goodbye".getBytes();
        System.out.println("Initiating write operation 2");
        fileChannel.write(ByteBuffer.wrap(contents), start, "Write operation 2", handler);
